 ...
 * Adapted for Svelte: also matches .svelte files
 */
...
const rule = {
  meta: {
    ...
    messages: {
      moleculeTooLarge: '[ARCHITECTURE] Molecule {{name}} has {{lineCount}} lines (max {{max}}). Decompose into feature-specific atoms.',
      organismTooLarge: '[ARCHITECTURE] Organism {{name}} has {{lineCount}} lines (max {{max}}). Extract molecules or decompose.',
    },
  },
