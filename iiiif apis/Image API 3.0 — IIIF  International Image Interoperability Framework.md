---
created: 2025-02-17T15:05:28 (UTC -08:00)
tags: []
...
---
## Status of this Document[](https://iiif.io/api/image/3.0/#status-of-this-document)

**This Version:** 3.0.0

**Latest Stable Version:** [3.0.0](https://iiif.io/api/image/3.0/ "Image API")

**Previous Version:** [2.1.1](https://iiif.io/api/image/2.1/ "Image API 2.1")
...
## 1\. Introduction[](https://iiif.io/api/image/3.0/#1-introduction)
...
### 1.1. Audience and Scope[](https://iiif.io/api/image/3.0/#11-audience-and-scope)
...
Implementations may use a pre-generated set of files served as static web resources and still enable rich user experiences. Dynamic image server implementations may provide additional functionality beyond the base [level of compliance](https://iiif.io/api/image/3.0/#6-compliance-level-and-profile-document "6. Compliance Level and Profile Document").

### 1.2. Terminology[](https://iiif.io/api/image/3.0/#12-terminology)
...
The term **full image** is used to refer to the entire area of the underlying image content, with the pixel dimensions given in the [image information](https://iiif.io/api/image/3.0/#5-image-information "5. Image Information") document, and which is imagined as the starting point for [image requests](https://iiif.io/api/image/3.0/#4-image-requests "4. Image Requests").
...
## 2\. URI Syntax[](https://iiif.io/api/image/3.0/#2-uri-syntax)
...
The parameters of the Image Request URI include region, size, rotation, quality and format, which define the characteristics of the returned image. These are described in detail in [Image Requests](https://iiif.io/api/image/3.0/#4-image-requests "4. Image Requests").

### 2.2. Image Information Request URI Syntax[](https://iiif.io/api/image/3.0/#22-image-information-request-uri-syntax)
...
Size and region parameters in pixels _must_ be non-negative integers. Size and region parameters in percentages and the rotation parameter _must_ be positive floating point numbers or integers. For details of the representation of floating point numbers in IIIF URIs, see the [Floating Point Values](https://iiif.io/api/image/3.0/#47-floating-point-values "4.7. Floating Point Values") section.

Servers _should_ support [CORS](https://iiif.io/api/image/3.0/#71-cors "7.1. CORS") on image responses.

### 4.1. Region[](https://iiif.io/api/image/3.0/#41-region)
...
<table><tbody><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/full.png" alt="Full Region"><p><strong>1</strong> region=full</p><p><code>.../full/max/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/region_square.png" alt="Square Region"><p><strong>2</strong> region=square</p><p><code>.../square/max/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/region_px.png" alt="Region by Pixels"><p><strong>3</strong> region=125,15,120,140</p><p><code>.../125,15,120,140/max/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/region_pct.png" alt="Region by Percent"><p><strong>4</strong> region=pct:41.6,7.5,40,70</p><p><code>.../pct:41.6,7.5,40,70/max/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/region_px_over.png" alt="Region by Pixels"><p><strong>5</strong> region=125,15,200,200</p><p><code>.../125,15,200,200/max/0/default.jpg</code></p><p><em>N.B. Returned image is 175,185 px</em></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/region_pct_over.png" alt="Region by Percent"><p><strong>6</strong> region=pct:41.6,7.5,66.6,100</p><p><code>.../pct:41.6,7.5,66.6,100/max/0/default.jpg</code></p><p><em>N.B. Returned image is 175,185 px</em></p></td></tr></tbody></table>

### 4.2. Size[](https://iiif.io/api/image/3.0/#42-size)
...
| Form | Description |
| --- | --- |
| `max` | The extracted region is returned at the maximum size available, but will not be upscaled. The resulting image will have the pixel dimensions of the extracted region, unless it is constrained to a smaller size by `maxWidth`, `maxHeight`, or `maxArea` as defined in the [Technical Properties](https://iiif.io/api/image/3.0/#52-technical-properties "5.2 Technical Properties") section. |
| `^max` | The extracted region is scaled to the maximum size permitted by `maxWidth`, `maxHeight`, or `maxArea` as defined in the [Technical Properties](https://iiif.io/api/image/3.0/#52-technical-properties "5.2 Technical Properties") section. If the resulting dimensions are greater than the pixel width and height of the extracted region, the extracted region is upscaled. |
...
<table><tbody><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_max.png" alt="Maximum Size"><p><strong>1</strong> size=max</p><p><code>.../full/max/0/default.jpg</code></p><p><em>N.B. Assuming that the image has a <code>maxWidth</code> of 200px</em></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_max.png" alt="Above Maximum Size"><p><strong>1</strong> size=^max</p><p><code>.../full/^max/0/default.jpg</code></p><p><em>N.B. Assuming that the image has a <code>maxWidth</code> of 360px</em></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_wc.png" alt="Size by Width"><p><strong>2</strong> size=150,</p><p><code>.../full/150,/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_max.png" alt="Size by Width Above Maximum"><p><strong>2</strong> size=^360,</p><p><code>.../full/^360,/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_ch.png" alt="Size by Height"><p><strong>3</strong> size=,150</p><p><code>.../full/,150/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_max.png" alt="Size by Height Above Maximum"><p><strong>3</strong> size=,^240</p><p><code>.../full/,^240/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_pct.png" alt="Size by Percent"><p><strong>4</strong> size=pct:50</p><p><code>.../full/pct:50/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_max.png" alt="Size by Percent Above Maximum"><p><strong>4</strong> size=pct:120</p><p><code>.../full/pct:120/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_wch.png" alt="Size by Width,Height"><p><strong>5</strong> size=225,100</p><p><code>.../full/225,100/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_wch.png" alt="Size by Width,Height Above Maximum"><p><strong>5</strong> size=^360,360</p><p><code>.../full/^360,360/0/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_bwch.png" alt="Size By Bang Width Height"><p><strong>6</strong> size=!225,100</p><p><code>.../full/!225,100/0/default.jpg</code></p><p><em>N.B. Returned image is 150,100 px</em></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/size_up_bwch.png" alt="Size By Bang Width Height Above Maximum"><p><strong>6</strong> size=^!360,360</p><p><code>.../full/^!360,360/0/default.jpg</code></p><p><em>N.B. Returned image is 360,240 px</em></p></td></tr></tbody></table>

### 4.3. Rotation[](https://iiif.io/api/image/3.0/#43-rotation)
...
<table><tbody><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/full.png" alt="Rotation 0"><p><strong>1</strong> rotation=0</p><p><code>.../full/max/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/rotate_180.png" alt="Rotation 180"><p><strong>2</strong> rotation=180</p><p><code>.../full/max/180/default.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/rotate_90.png" alt="Rotation 90"><p><strong>3</strong> rotation=90</p><p><code>.../full/max/90/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/rotate_22-5.png" alt="Rotation 22.5"><p><strong>4</strong> rotation=22.5</p><p><code>.../full/max/22.5/default.png</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/mirror.png" alt="Mirroring"><p><strong>5</strong> rotation=!0</p><p><code>.../full/max/!0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/mirror_180.png" alt="Mirroring and Rotation"><p><strong>6</strong> rotation=!180</p><p><code>.../full/max/!180/default.jpg</code></p></td></tr></tbody></table>

### 4.4. Quality[](https://iiif.io/api/image/3.0/#quality)
...
The `default` quality exists to support [level 0 compliant implementations](https://iiif.io/api/image/3.0/compliance/#quality "Image API Compliance: Quality") that may not know the qualities of individual images in their collections. It also provides a convenience for clients that know the values for all other parameters of a request except the quality (e.g. `.../full/120,80/90/{quality}.png` to request a thumbnail) in that a preliminary image information request that would only serve to find out which qualities are available can be avoided.

Regardless of level of compliance, services that make additional qualities beyond `default` available _must_ list those qualities in the [`extraQualities` property](https://iiif.io/api/image/3.0/#57-extra-functionality "5.7. Extra Functionality") of the response to the [Image Information Request](https://iiif.io/api/image/3.0/#5-image-information "5. Image Information"). A request for an image with an unsupported quality value _should_ return a 400 (Bad Request) status code.
...
<table><tbody><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/full.png" alt="Default Quality"><p><strong>1</strong> quality=default</p><p><code>.../full/max/0/default.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/full.png" alt="Color Quality"><p><strong>2</strong> quality=color</p><p><code>.../full/max/0/color.jpg</code></p></td></tr><tr><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/gray.png" alt="Gray Quality"><p><strong>3</strong> quality=gray</p><p><code>.../full/max/0/gray.jpg</code></p></td><td><img src="Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/bitonal.png" alt="Bitonal Quality"><p><strong>4</strong> quality=bitonal</p><p><code>.../full/max/0/bitonal.jpg</code></p></td></tr></tbody></table>

### 4.5. Format[](https://iiif.io/api/image/3.0/#45-format)
...
### 4.6. Order of Implementation[](https://iiif.io/api/image/3.0/#46-order-of-implementation)
...
![Order of Implementation](Image%20API%203.0%20%E2%80%94%20IIIF%20%20International%20Image%20Interoperability%20Framework/transformation.png)

**1** region=125,15,120,140 size=90, rotation=!345 quality=gray

`.../125,15,120,140/90,/!345/gray.jpg`

### 4.7. Floating Point Values[](https://iiif.io/api/image/3.0/#47-floating-point-values)
...
### 4.8. Canonical URI Syntax[](https://iiif.io/api/image/3.0/#48-canonical-uri-syntax)
...
| --- | --- |
| region | `full` if the full image is requested  
otherwise the _`x,y,w,h`_ syntax. |
| size | `max` if the maximum size without upscaling is requested,  
...
| rotation | `!` if the image is mirrored, followed by an integer if possible, otherwise a floating point value represented according to the recommendations of the [Floating Point Values](https://iiif.io/api/image/3.0/#47-floating-point-values "4.7. Floating Point Values") section. |
| quality | `default` if the server’s default quality is requested,  
...
### 4.9. Extensions[](https://iiif.io/api/image/3.0/#49-extensions)

The IIIF Image API is extensible within the [Image Request URI Syntax](https://iiif.io/api/image/3.0/#22-image-information-request-uri-syntax "2.2. Image Information Request URI") through the addition of new parameter patterns for the [region](https://iiif.io/api/image/3.0/#41-region "4.1. Region"), [size](https://iiif.io/api/image/3.0/#42-size "4.2. Size") and [rotation](https://iiif.io/api/image/3.0/#43-rotation "4.3. Rotation") parameters, or new values for the [quality](https://iiif.io/api/image/3.0/#quality "4.4. Quality") and [format](https://iiif.io/api/image/3.0/#45-format "4.5. Format") parameters. Request information beyond the scope of the existing parameters could be passed to an image server as query parameters. Extension features _should_ be described in the image information document following the guidelines in the [Extra Functionality](https://iiif.io/api/image/3.0/#57-extra-functionality "5.7. Extra Functionality") section.

## 5\. Image Information[](https://iiif.io/api/image/3.0/#5-image-information)
...
### 5.1. Image Information Request[](https://iiif.io/api/image/3.0/#51-image-information-request)
...
Servers _should_ support [CORS](https://iiif.io/api/image/3.0/#71-cors "7.1. CORS") on image information responses.

### 5.2. Technical Properties[](https://iiif.io/api/image/3.0/#52-technical-properties)

The JSON response has several technical properties that describe the available functionality for the image content.

| Property | Required? | Description |
| --- | --- | --- |
| `@context` | Required | The `@context` property _should_ appear as the very first key-value pair of the JSON representation. Its value _must_ be either the URI `http://iiif.io/api/image/3/context.json` or a JSON array with the URI `http://iiif.io/api/image/3/context.json` as the last item. The `@context` tells Linked Data processors how to interpret the image information. If extensions are used then their context definitions _should_ be included in this top-level `@context` property. |
| `id` | Required | The base URI of the image as defined in [URI Syntax](https://iiif.io/api/image/3.0/#2-uri-syntax "2. URI Syntax"), including scheme, server, prefix and identifier without a trailing slash. |
...
| `profile` | Required | A string indicating the highest [compliance level](https://iiif.io/api/image/3.0/#6-compliance-level-and-profile-document "6. Compliance Level and Profile Document") which is fully supported by the service. The value _must_ be one of `level0`, `level1`, or `level2`. |
...
### 5.3. Sizes[](https://iiif.io/api/image/3.0/#53-sizes)
...
The JSON objects in the `tiles` array have the properties in the following table. The `width` and `height` should be used to fill the size parameter, and be used together with the `scaleFactors` to compute the region parameter of the image requests. This is described in detail in the [Implementation Notes](https://iiif.io/api/image/3.0/implementation/ "Implementation Notes").
...
### 5.5. Preferred Formats[](https://iiif.io/api/image/3.0/#55-preferred-formats)
...
| `extraFeatures` | Optional | An array of strings identifying features supported by the service, in addition to the ones specified in the referenced profile. These strings are defined either in the [table](https://iiif.io/api/image/3.0/#features-table) below or by [registering an extension](https://iiif.io/api/extension/). |
...
A server that supports `sizeUpscaling` _must_ specify `maxWidth` or `maxArea` (see [Technical Properties](https://iiif.io/api/image/3.0/#52-technical-properties "5.2 Technical Properties")).
...
### 5.8. Linking Properties[](https://iiif.io/api/image/3.0/#58-linking-properties)

The JSON response _may_ contain linking properties that reference external resources, including services that make additional functionality available to a viewer. The linking properties have the same semantics and requirements as those in the [Presentation API](https://iiif.io/api/presentation/3.0/ "Presentation API").
...
| `type` | Required | The type or class of this resource. Recommendations for basic types such as image, text or audio are [given in the Presentation API](https://iiif.io/api/presentation/3.0/#type). (The `@type` property _may_ be used in `service` objects for backwards compatibility as described above.) |
| `label` | Recommended | A human-readable label for this resource. The `label` property can be fully internationalized, and each language can have multiple values. This pattern is described in more detail in [the languages section of the Presentation API](https://iiif.io/api/presentation/3.0/#language-of-property-values "Language of Property Values"). |
...
| `profile` | Recommended for `seeAlso`, `service` | A schema or named set of functionality available from this resource. The profile can further clarify the `type` and/or `format` of an external resource. The value must be a string, either taken from the [Registry of Profiles](https://iiif.io/api/registry/ "IIIF Extension Registry") or a URI. |
...
### 5.9. Complete Response[](https://iiif.io/api/image/3.0/#59-complete-response)
...
## 6\. Compliance Level and Profile Document[](https://iiif.io/api/image/3.0/#6-compliance-level-and-profile-document)

The image information document _must_ specify the extent to which the API is supported by including the compliance level as the value of the `profile` property. The compliance level _must_ be one of those listed in the [Image API Compliance](https://iiif.io/api/image/3.0/compliance/ "Image API Compliance") document and shown in the table below. The compliance level _should_ be the highest compliance level for which all requirements are met. The compliance levels each correspond with a profile document that describes the set of features required by that level, as discussed in the [Image Information](https://iiif.io/api/image/3.0/#5-image-information "5. Image Information") section. A server _may_ declare different compliance levels for images with different identifiers.
...
A recipe for setting this header on the Apache HTTP Server is shown in the [Apache HTTP Server Implementation Notes](https://iiif.io/api/annex/notes/apache/#set-compliance-link-header "Apache HTTP Server Implementation Notes: Set Compliance Link Header").

## 7\. Server Responses[](https://iiif.io/api/image/3.0/#7-server-responses)

Servers _must_ support the HTTP GET method for retrieval of Image API resources. Servers _should_ support the HTTP OPTIONS method as part of the [CORS](https://iiif.io/api/image/3.0/#71-cors "7.1. CORS") preflight request pattern, and it is _recommended_ that implementations also support the HTTP HEAD method.

### 7.1. CORS[](https://iiif.io/api/image/3.0/#71-cors)

Servers _should_ support reuse of Image API resources by following the relevant requirements of the [CORS specification](https://www.w3.org/TR/cors/ "Cross-Origin Resource Sharing"), including the `Access-Control-Allow-Origin` header and the preflight request pattern. A recipe for enabling these behaviors is provided in the [Apache HTTP Server Implementation Notes](https://iiif.io/api/annex/notes/apache/#conditional-content-types "Apache HTTP Server Implementation Notes: Conditional Content Types").

### 7.2. Successful Responses[](https://iiif.io/api/image/3.0/#72-successful-responses)
...
### 7.3. Error Conditions[](https://iiif.io/api/image/3.0/#73-error-conditions)
...
| 401 Unauthorized | Authentication is required and not provided. See the [Authentication](https://iiif.io/api/image/3.0/#8-authentication "8. Authentication") section for details. |
| 403 Forbidden | The user, authenticated or not, is not permitted to perform the requested operation. |
| 404 Not Found | The image resource specified by [identifier](https://iiif.io/api/image/3.0/#3-identifier "3. Identifier") does not exist, the value of one or more of the parameters is not supported for this image service, or the requested size is greater than the limits specified. |
...
### 7.4. HTTP Versions[](https://iiif.io/api/image/3.0/#74-http-versions)
...
## 8\. Authentication[](https://iiif.io/api/image/3.0/#8-authentication)
...
No new authentication mechanisms are proposed, nor roles for authorization business logic. Instead, it is expected that authentication requirements and processes are handled outside of any IIIF\-specific context, but within a IIIF\-aware access control workflow. Please see the [IIIF Authentication specification](https://iiif.io/api/auth/1.0/ "IIIF Authentication API 1.0").

## 9\. URI Encoding and Decoding[](https://iiif.io/api/image/3.0/#9-uri-encoding-and-decoding)
...
## 10\. Security Considerations[](https://iiif.io/api/image/3.0/#10-security-considerations)
...
## 11\. Appendices[](https://iiif.io/api/image/3.0/#11-appendices)

### A. Versioning[](https://iiif.io/api/image/3.0/#a-versioning)
...
### B. Acknowledgments[](https://iiif.io/api/image/3.0/#b-acknowledgments)
...
### C. Change Log[](https://iiif.io/api/image/3.0/#c-change-log)

| Date | Description |
| --- | --- |
| 2020-06-03 | Version 3.0 (Orange Blooms) [View change log](https://iiif.io/api/image/3.0/change-log/ "Image API 3.0 Change Log") |
| 2017-06-09 | Version 2.1.1 [View change log](https://iiif.io/api/image/2.1/change-log-211/ "Image API 2.1.1 Change Log") |
| 2016-05-12 | Version 2.1 (Crowned Eagle) [View change log](https://iiif.io/api/image/2.1/change-log/ "Change Log for Version 2.1") |
| 2014-09-11 | Version 2.0 (Voodoo Bunny) [View change log](https://iiif.io/api/image/2.0/change-log/ "Change Log for Version 2.0") |
| 2013-09-17 | Version 1.1 (unnamed) [View change log](https://iiif.io/api/image/1.1/change-log/ "Change Log for Version 1.1") |
