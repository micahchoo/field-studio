...
// ============================================================================
// Extension Arrays Tests
// ============================================================================

describe('Extension Arrays', () => {
  it('IMAGE_EXTENSIONS should contain all image types', () => {
  ...
  it('VIDEO_EXTENSIONS should contain all video types', () => {
  ...
  it('AUDIO_EXTENSIONS should contain all audio types', () => {
  ...
  it('TEXT_EXTENSIONS should contain all text types', () => {
  ...
  it('MODEL_EXTENSIONS should contain all 3D model types', () => {
...
describe('MIME_TYPE_MAP', () => {
  it('should have correct structure for all entries', () => {
    for (const [ext, info] of Object.entries(MIME_TYPE_MAP)) {
      ...
      expect(info).toHaveProperty('motivation');
      expect(['Image', 'Video', 'Sound', 'Text', 'Dataset', 'Model']).toContain(info.type);
      expect(['painting', 'supplementing']).toContain(info.motivation);
    }
  });

  it('should have consistent extension keys (lowercase)', () => {
    for (const ext of Object.keys(MIME_TYPE_MAP)) {
