...
describe('provenanceService singleton', () => {
  ...
  it('should have all service methods', () => {
    expect(provenanceService.recordCreate).toBeInstanceOf(Function);
    expect(provenanceService.recordUpdate).toBeInstanceOf(Function);
    expect(provenanceService.getHistory).toBeInstanceOf(Function);
    expect(provenanceService.exportPREMIS).toBeInstanceOf(Function);
  });
});
